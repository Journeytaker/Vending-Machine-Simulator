...
HD_PWD='C:/Users/dillo/Desktop/Vending Machine Simulator/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingMachineFSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VendingMachineFSM.tcl -notrace
