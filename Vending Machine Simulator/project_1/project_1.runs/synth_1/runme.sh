...
HD_PWD='C:/Users/dillo/Desktop/Vending Machine Simulator/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VendingMachineFSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VendingMachineFSM.tcl
